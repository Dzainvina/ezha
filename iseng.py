...
def balik():
    d = input("\033[1;33mCoba lagi? (y/t): ")
    if d == "y":
       subprocess.call("python call.py",shell=True)
         ...
         os.system("exit")
bersih()
subprocess.call("figlet ezha |lolcat",shell=True)
banner = """
\033[0;34m
==================================================
Recoder  \033[1;33m:\033[1;96mDzainvina\033[1;33m
Website \033[1;33m:\033[1;96mhttps://termux.id\033[1;97m
Whatsapp  \033[1;33m:\033[1;92m+628387757xxxx\033[0;34m
==================================================
"""
print (banner)
jm = int(input("\033[1;97m[\033[0;34mmasukan jumlah spam\033[1;97m]:\033[1;93m"))
time.sleep(2)
subprocess.call("nano iseng.py",shell=True)
